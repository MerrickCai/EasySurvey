    ...
    <div class="target-con">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="14"
          ...
          <g opacity="1" transform="translate(0 0)  rotate(0 7 7)">
            ...
            <g mask="url(#bg-mask-0)">
              <path id="分组 1" fill-rule="evenodd" style="fill:#1E6FFF"
                transform="translate(1.8074218750000006 1.7541015625000003)  rotate(0 5.192578124999999 5.6833984375)"
                opacity="1"
                d="M10.39 1.31C10.39 0.59 9.79 0 9.07 0L8.25 0L8.25 1.09C8.25 1.58 7.86 1.97 7.38 1.97L3.01 1.97C2.53 1.97 2.13 1.57 2.13 1.09L2.13 0L1.31 0C0.59 0 0 0.59 0 1.31L0 10.06C0 10.78 0.59 11.37 1.31 11.37L9.07 11.37C9.79 11.37 10.38 10.78 10.38 10.06L10.38 6.91L10.39 4.13L10.39 1.31Z M7.81145 7.95293L2.57145 7.95293C2.33145 7.95293 2.13145 8.15293 2.13145 8.39293C2.13145 8.63293 2.33145 8.83293 2.57145 8.83293L7.81145 8.83293C8.06145 8.83293 8.25145 8.63293 8.25145 8.39293C8.25145 8.15293 8.06145 7.95293 7.81145 7.95293Z M7.81145 5.90215L2.57145 5.90215C2.33145 5.90215 2.13145 6.10215 2.13145 6.34215C2.13145 6.58215 2.33145 6.78215 2.57145 6.78215L7.81145 6.78215C8.06145 6.78215 8.25145 6.58215 8.25145 6.34215C8.25145 6.10215 8.06145 5.90215 7.81145 5.90215Z M7.81145 3.85137L2.57145 3.85137C2.33145 3.85137 2.13145 4.05137 2.13145 4.29137C2.13145 4.53137 2.33145 4.73137 2.57145 4.73137L7.81145 4.73137C8.06145 4.73137 8.25145 4.53137 8.25145 4.29137C8.25145 4.05137 8.06145 3.85137 7.81145 3.85137Z " />
              <path id="路径 5" fill-rule="evenodd" style="fill:#1E6FFF"
                transform="translate(4.5951171875 0.8777343749999998)  rotate(0 2.4048828125000004 1.09375)" opacity="1"
                d="M4.81,1.75L4.81,0.88L4.15,0.88L4.15,0.44C4.15,0.2 3.96,0 3.72,0L1.09,0C0.85,0 0.66,0.2 0.66,0.44L0.66,0.88L0,0.88L0,1.75C0,1.99 0.2,2.19 0.44,2.19L4.37,2.19C4.61,2.19 4.81,1.99 4.81,1.75Z " />
            </g>
          </g>
        </svg>
      ...
      <span class="useful number">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12" height="12"
          ...
          <g opacity="1"
            transform="translate(0.000823974609375 0.0009765625)  rotate(0 5.993696627754463 5.998187893822559)">
            <path id="路径 1" fill-rule="evenodd" style="fill:#1E6FFF"
              transform="translate(6.061352554535889 0)  rotate(0 2.9630203504865187 2.963020350486519)" opacity="1"
              d="M0.86,5.93L5.07,5.93C5.32,5.93 5.56,5.81 5.72,5.62C5.89,5.43 5.96,5.18 5.91,4.93C5.49,2.41 3.52,0.44 1,0.01C0.75,-0.03 0.5,0.04 0.3,0.2C0.11,0.37 0,0.6 0,0.86L0,5.07C0,5.54 0.38,5.93 0.86,5.93Z " />
            <path id="路径 2" fill-rule="evenodd" style="fill:#1E6FFF"
              transform="translate(0 1.3663985921497064)  rotate(0 5.315854476210879 5.314988597747705)" opacity="1"
              d="M10.43,5.58C10.26,5.38 10.02,5.27 9.76,5.28L5.77,5.28C5.54,5.28 5.35,5.08 5.35,4.85L5.35,0.87C5.35,0.61 5.24,0.37 5.05,0.21C4.85,0.04 4.59,-0.03 4.34,0.01C1.69,0.52 -0.16,2.92 0.01,5.62C0.18,8.31 2.33,10.45 5.02,10.62C7.72,10.79 10.11,8.93 10.62,6.28C10.66,6.03 10.59,5.77 10.43,5.58Z " />
          </g>
        </svg>
      ...
      <span class="plan number">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12" height="12"
          ...
          <g opacity="1" transform="translate(0 0)  rotate(0 6 6)">
            ...
            <g mask="url(#bg-mask-0)">
              <path id="分组 1" fill-rule="evenodd" style="fill:#1E6FFF" transform="translate(0 0)  rotate(0 5.88 5.88)"
                opacity="1"
                d="M0 5.88C0 9.12 2.64 11.76 5.88 11.76C9.12 11.76 11.76 9.12 11.76 5.88C11.76 2.64 9.12 0 5.88 0C2.64 0 0 2.64 0 5.88Z M4.61 8.904L3.02 7.344L2.4 9.484L4.61 8.904Z M8.924 4.946L7.324 3.336L3.384 6.956L4.994 8.666L8.924 4.946Z M10.172 3.86341C10.222 3.31341 9.172 2.35341 8.612 2.30341C8.352 2.28341 7.752 3.00341 7.752 3.00341L9.412 4.70341C9.412 4.70341 10.152 4.15341 10.172 3.86341Z " />
            </g>
          </g>
        </svg>
        <div class="planbox">
          <i v-show="PlannumShow">
            ...
            <img class="change" style="display: inline" v-lazy="'/assets/revise.png'" alt="" @click="ChangePlanShow" />
          </i>
          <input ref="planinput" type="number" v-show="!PlannumShow"
            v-model.number="filenews.context.questionnaire.totalNumber" placeholder="请输入计划问卷数"
            @blur="PlannumShow = true" @keyup.enter="PlannumShow = true" />
        </div>
      </span>

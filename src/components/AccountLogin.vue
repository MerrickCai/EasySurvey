...
<template>
     <div class="wrapper">
          ...
          <input class="info" type="text" v-model="loginInfo.account" placeholder="用户名 / 手机号 / Email" onfocus="this.placeholder=''"
               onblur="this.placeholder='用户名 / 手机号 / Email'">
          <input class="info password" type="password" v-model="loginInfo.pass" placeholder="请输入登录密码" onfocus="this.placeholder=''"
